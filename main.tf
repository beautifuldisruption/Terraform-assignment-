module "resource_group" {
  source    = "./modules/rgroup-n01651005"
...
module "network" {
  source              = "./modules/network-n01651005"
  humber_id           = var.humber_id
  location            = var.location
...
module "common" {
  source              = "./modules/common-n01651005"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
  tags                = var.tags
...
module "linux_vms" {
  source                     = "./modules/vmlinux-n01651005"
  humber_id                  = var.humber_id
  location                   = var.location
  resource_group_name        = module.resource_group.rg_name
...
module "windows_vms" {
  source                     = "./modules/vmwindows-n01651005"
  humber_id                  = var.humber_id
  location                   = var.location
  resource_group_name        = module.resource_group.rg_name
  subnet_id                  = module.network.subnet_id
...
module "data_disks" {
  source              = "./modules/datadisk-n01651005"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
...
module "load_balancer" {
  source              = "./modules/loadbalancer-n01651005"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
  tags                = var.tags
...
module "database" {
  source                  = "./modules/database-n01651005"
  humber_id               = var.humber_id
  location                = var.location
  resource_group_name     = module.resource_group.rg_name
  admin_username          = var.admin_username
